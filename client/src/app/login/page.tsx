...
// You can use a library like 'lucide-react' for icons in a real Next.js app.
// For this self-contained example, I'll use an inline SVG for the Google icon.
const GoogleIcon = () => (
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-950 border border-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-2">Enter your email below to login to your account.</p>
          </div>
